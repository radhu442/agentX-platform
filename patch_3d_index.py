...
# Replace the #register links with /register and /login
html = html.replace('href="#register" class="nav-cta">Get Access', 'href="/login" class="nav-cta">Login</a> <a href="/register" class="nav-cta glowing" style="margin-left: 10px;">Register')
